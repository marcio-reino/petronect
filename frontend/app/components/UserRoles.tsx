    ...
    <>
      ...
      <div className="mb-6">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4 gap-3">
          <div>
            <h1 className="text-2xl font-bold text-gray-800 dark:text-[#eeeeee]">Grupos de Acesso</h1>
            <p className="text-sm text-gray-500 dark:text-[#aaaaaa]">Gerencie os grupos e suas permissões de acesso</p>
          </div>
      ...
      <div className="bg-white dark:bg-[#2a2a2a] rounded-lg shadow-sm border border-gray-200 dark:border-[#444444]">
        ...
        {filteredRoles.length > 0 && (
          <div className="px-4 py-3 md:px-6 md:py-4 border-t border-gray-200 dark:border-[#444444] bg-white dark:bg-[#2a2a2a]">
